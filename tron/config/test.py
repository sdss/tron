...
nubs = ('client', 'nclient', 'tcc', 'lco', 'alerts', 'sop', 'platedb', 'gcamera', 'guider',
        'apogeecal', 'apogee', 'apogeeql', 'TUI')

actors = dict(
    alerts=dict(host="localhost", port=9995, actorName='alertsActor'),
    ...
    guider=dict(host="loalhost", port=9994, actorName='guiderActor'),
