...
nubs = ('client', 'nclient', 'tcc', 'lco', 'alerts', 'sop', 'platedb', 'gcamera', 'guider', 'bmo',
        'apogeecal', 'apogee', 'apogeeql', 'TUI')

actors = dict(
    alerts=dict(host="sdss4-hub.lco.cl", port=9995, actorName='alertsActor'),
    lco=dict(host="sdss4-hub.lco.cl", port=9990, actorName='apoActor'),
    gcamera=dict(host="guia.lco.cl", port=9993, actorName='gcameraICC'),
