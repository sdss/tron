...
def reload(module, exclude=['sys', '__builtin__', '__main__', 're', 'time', 'os', 'sys', 'atexit', 'imp',
                            'inspect', 'dis', 'stat', 'pprint', 'socket', 'sha', 'binascii', 'base64',
                            'select', 'types', 'linecache', 'traceback', 'math', 'string', 'strop',
                            '__future__']):
