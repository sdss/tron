...
nubs = ('client', 'nclient', 'mcp', 'tcc', 'apo', 'sop', 'platedb', 'gcamera', 'boss', 'hartmann',
        'guider', 'apogeecal', 'apogee', 'apogeeql', 'alerts', 'TUI')

actors = dict(
    alerts=dict(host="sdss4-hub.apo.nmsu.edu", port=9995, actorName='alertsActor'),
