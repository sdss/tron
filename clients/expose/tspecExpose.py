...
class TspecExposureActor(InstExposure.InstExposure):
    def __init__(self, **argv):
        ...
        self.helpText = ("tspecExpose COMMAND [ARGS]",
                         "   COMMAND is one of:",
                         "     help         - you got it!",
                         ...
                         "     The APO root directory is currently /export/images/PROGRAMNAME on hub35m, where ",
                         ...
                         "       hub35m:/export/images/PU04/night1/cals.0014.fit and hub35m:/export/images/PU04/night1/cals.0015.fit",
                         "     And if another PU04 user then sent:",
                         "       echExpose bias name='night1/bias.'",
                         "     that user would get:",
                         "       hub35m:/export/images/PU04/night1/bias.0016.fit",
                         "")
    ...
    def _parse(self, cmd):
        ...
        if self.debug >= 0:
            CPL.log("TspecExposureHandler", "new command: %s" % (cmd.raw_cmd))
